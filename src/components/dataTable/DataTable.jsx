...
export function DataTablePri({ className, header_row_className, table_head_className, table_title, columns, data }) {
    ...
    return (
        <div className="w-full">
            ...
            <h2 className="text-[#0797B7]"> {table_title}  </h2>
            ...
            <div className="flex items-center py-4">
                ...
                <Input
                    ...
                    className="max-w-sm border-[1px] border-[#0797b775]"
                />

                {/* DropDown MenU */}
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <Button variant="outline" className="ml-auto border-[1px] border-[#0797b775]">
                    ...
                    <TableBody>
                        {table?.getRowModel()?.rows?.length ? (
                            table?.getRowModel()?.rows?.map((row) => (
                                <TableRow
                                    key={row.id}
                                    data-state={row.getIsSelected() && "selected"} className={className}
                                >
